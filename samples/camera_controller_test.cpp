...
/////// Stereo camera
	...
	s_param[L] = bs::CameraParams(12345678, FLYCAPTURE_MONO8, cv::Size(640, 480), 30.f, 5.f, 30.f);
	s_param[R] = bs::CameraParams(87654321, FLYCAPTURE_RGB8, cv::Size(1280, 1080), 15.f, 3.f, 60.f);
...
/////// Single camera
	bs::param::gl_file_cam_param = "cam_param.xml";					// Or rewrite sorce file
	bs::CameraController cam_cntl_1;
	cam_cntl_1.initFromFile();
	...
	cv::Size view_size = cam_cntl_1.calcViewSize(640);
